module mdtn_addr::mdtn {
    ...
    fun init_module(deployer: &signer) {
        ...
        primary_fungible_store::create_primary_store_enabled_fungible_asset(
            ...
            utf8(ASSET_SYMBOL), 
            8, 
            utf8(b"https://finance.ua/uploads/media/96x96/04/1004-eurokupuri2_euro.jpg?v=1-0"),  // TODO here ico
            utf8(b"https://finance.ua/uploads/media/96x96/04/1004-eurokupuri2_euro.jpg?v=1-0"), 
        );
    ...
    inline fun assert_admin(deployer: &signer) {
        assert!(signer::address_of(deployer) == @mdtn_addr, EUNAUTHORIZED);
    }
    ...
    // Expose the MDTN struct and register_account function
    public fun register_account(account: &signer) {
        primary_fungible_store::ensure_primary_store_exists(signer::address_of(account), metadata());
    }
}